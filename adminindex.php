<?php
    ...
    $datenow = date('Y-m-d');
    $sql_update_outtime = 'update projectinfo set pstatus="outtime" where endtime < "'.$datenow.'"';
    mysqli_query($link,$sql_update_outtime);
    //再更新项目完成的状态
    $sql_update_end = 'update projectinfo set pstatus="end" where pschedule=100 and endtime > "'.$datenow.'"';
    mysqli_query($link , $sql_update_end);
?>
...
<div class="container">
    ...
    <div class="leftsidebar_box">
        ...
        <dl class="custom">
            ...
            <dd class="first_dd"><a href="adduserform.php" target="window">添加成员</a></dd>
            <dd><a href="userlist.php?key=" target="window">成员列表</a></dd>
            <dd><a href="kaoqinlist.php" target="window">考勤</a></dd>
        </dl>

        <dl class="channel">
            <dt>项目管理<img src="img/left/select_xl01.png"></dt>
            <dd class="first_dd"><a href="fabuprojectform.php" target="window">项目发布</a></dd>
            <dd><a href="projectlist.php?key=" target="window">项目进度</a></dd>
        </dl>
        <dl class="syetem_management">
            <dt>公告管理<img src="img/left/select_xl01.png"></dt>
            <dd class="first_dd"><a href="fabiaonoticform.php" target="window">发布公告</a></dd>
